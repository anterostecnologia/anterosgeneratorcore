...
import br.com.anteros.nosql.persistence.session.NoSQLRepositoryException;
...
public class MvcExceptionHandler {
	...
	public ResponseEntity<String> handleIllegalArgumentException(Exception ex) {
		...
		if (ex instanceof NoSQLRepositoryException && ex.getCause() instanceof ConstraintViolationException) {
