...
public class ResourcePersistenceConfiguration extends AbstractSQLPersistenceConfiguration {
	...
	public PlatformTransactionManager txManager(DataSource dataSourceSQL, SQLSessionFactory sessionFactorySQL) {
		if (dataSourceSQL != null && sessionFactorySQL != null) {
			AnterosTransactionManager txManager = new AnterosTransactionManager();
			txManager.setDataSource(dataSourceSQL);
