...
public class AnterosGenerationConstants {
	...
	public static final String GLOBAL_METHOD_SECURITY_CONFIGURATION_TEMPLATE = "globalMethodSecurityConfiguration.ftl";

	public static final String PERSISTENCE_CONFIGURATION_WITH_PROPERTIES_TEMPLATE = "persistenceConfigurationWithProperties.ftl";

	public static final String PERSISTENCE_CONFIGURATION_TEMPLATE = "persistenceConfiguration.ftl";
